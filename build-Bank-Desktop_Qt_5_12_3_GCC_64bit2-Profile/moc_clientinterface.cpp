...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ClientInterface_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ClientInterface_t qt_meta_stringdata_ClientInterface = {
    {
QT_MOC_LITERAL(0, 0, 15), // "ClientInterface"
QT_MOC_LITERAL(1, 16, 21), // "on_pushButton_clicked"
QT_MOC_LITERAL(2, 38, 0) // ""

    },
    "ClientInterface\0on_pushButton_clicked\0"
    ""
};
...
QT_INIT_METAOBJECT const QMetaObject ClientInterface::staticMetaObject = { {
    &QMainWindow::staticMetaObject,
    qt_meta_stringdata_ClientInterface.data,
    qt_meta_data_ClientInterface,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *ClientInterface::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ClientInterface.stringdata0))
